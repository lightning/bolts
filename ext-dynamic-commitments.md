...
## Feature Bits (BOLT 9 Amendments)

## Peer Protocol (BOLT 2 Amendments)

## Transactions (BOLT 3 Amendments)

## On-Chain Handling (BOLT 5 Amendments)

# *EUGENE'S ORIGINAL DRAFT FOLLOWS*
...
This change, in conjunction with the anchor commitment type, decreases the efficacy of the
