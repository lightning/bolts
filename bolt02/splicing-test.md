...
Alice initiates a splice, but disconnections happen when exchanging splice_locked:
   ...
   Alice                           Bob
     ...
     |                              |    +------------+        +------------+
     |                              |
     |      channel_reestablish     | next_funding_txid = null, your_last_funding_locked_txid = funding_tx1, my_current_funding_locked_txid = funding_tx2
     |----------------------------->|
     |      channel_reestablish     | next_funding_txid = null, your_last_funding_locked_txid = funding_tx1, my_current_funding_locked_txid = funding_tx1
     |<-----------------------------|
     |        splice_locked         |
     |----------------------------->|
     ...
     |      channel_reestablish     | next_funding_txid = null, your_last_funding_locked_txid = funding_tx1, my_current_funding_locked_txid = funding_tx2
     |----------------------------->|
     |      channel_reestablish     | next_funding_txid = null, your_last_funding_locked_txid = funding_tx2, my_current_funding_locked_txid = funding_tx2
     |<-----------------------------|
     |                              | Alice doesn't need to retransmit splice_locked, since Bob's your_last_funding_locked_txid indicates that he received it.
