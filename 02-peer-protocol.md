...
A recieving node, if they've already sent their `tx_signatures` has no guarantee
...
The `tx_abort` message allows for the cancelation of an in progress negotation,
