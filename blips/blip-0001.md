...
assigned and specified in [Bolt #9]
...
Message Types are assigned and specified in [Bolt #1]
...
great use case for a bLIP. TLVs are not assigned anywhere, but specified in [Bolt #1]
(https://github.com/lightningnetwork/lightning-rfc/blob/master/01-messaging.md).
...
This document was derived heavily from [Bitcoin's BIP-0002]
(https://github.com/bitcoin/bips/blob/master/bip-0002.mediawiki) written by Luke Jr. which 
in turn was derived from [Python's PEP-0001](https://www.python.org/dev/peps/). In many 
